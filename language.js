...
const translations = {
  en: {
    ...
    heroSubtitle: "I'm a researcher focused on Mechanistic Interpretability and AI4Science, working to fill the gap between Human and AI research capability for a coworking future.",
    ...
    heroCardBody1: "My research focuses on Mechanistic Interpretability and AI4Science — working to fill the gap between Human and AI research capability for a coworking future, where humans and AI collaborate seamlessly on scientific discovery.",
    ...
    aboutDesc: "A researcher focused on Mechanistic Interpretability and AI4Science to bridge the gap between Human and AI research capability.",
    aboutText1: "I'm a researcher focused on Mechanistic Interpretability and AI4Science. My goal is to fill the gap between Human and AI research capability, enabling a future where humans and AI cowork effectively on scientific problems.",
    aboutText2: "I focus on understanding how neural networks work internally (mechanistic interpretability) and applying AI to scientific discovery (AI4Science) to bridge the gap between what humans and AI can each contribute to research. I also work on Spiking Neural Networks on ASIC and ROS/Autoware tools for autonomous vehicles.",
    aboutText3: "I'm currently exploring opportunities in mechanistic interpretability research and AI4Science, with a passion for building a coworking future between humans and AI.",
  ...
  ja: {
    ...
    heroCardBody1: "私の研究は機械論的解釈可能性とAI4Scienceに焦点を当て、人間とAIの研究能力のギャップを埋めることで、人間とAIが科学的発見において協力できる共同作業の未来を追求しています。",
    ...
    aboutLabel: "自己紹介",
    aboutTitle: "簡単な自己紹介",
    aboutDesc: "機械論的解釈可能性とAI4Scienceを通じて、人間とAIの研究能力のギャップを埋める研究者。",
    aboutText1: "機械論的解釈可能性とAI4Scienceに焦点を当てた研究者です。人間とAIの研究能力のギャップを埋め、人間とAIが科学的問題に効果的に共同作業できる未来を目指しています。",
    aboutText2: "ニューラルネットワークの内部動作を理解すること（機械論的解釈可能性）とAIを科学的発見に応用すること（AI4Science）を通じて、人間とAIがそれぞれ研究に貢献できることのギャップを埋めることに注力しています。また、ASIC上のスパイキングニューラルネットワークや自動運転車両向けROS/Autowareツールにも取り組んでいます。",
    aboutText3: "現在、機械論的解釈可能性の研究とAI4Scienceの機会を探しています。人間とAIの共同作業の未来の構築に情熱を持っています。",
